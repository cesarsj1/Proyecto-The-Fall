...
public class Mando : MonoBehaviour
{
    ...
    public static int itemCount2 = 0; // Contador de objetos recogidos como variable estática
    ...
    void OnMouseUp()
    {
        ...
        {
            itemCount2++; // Incrementa el contador de objetos recogidos
            Destroy(gameObject); // Destruye el objeto

            if (itemCount2 == 1) // Verifica si todos los objetos han sido recogidos
            {
                ChangeScene();
            }
        }
